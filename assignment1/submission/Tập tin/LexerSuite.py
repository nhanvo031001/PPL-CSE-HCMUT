...
class LexerSuite(unittest.TestCase):
    ...
    def test_100_some_combo_float_literals(self):
        input = r"""
    ...
    def test_102_lower_upper_id(self):
    ...
    def test_103_confused_integer_literals(self):
        input = """000123
                    0x010101 
                    00345
                    0678
    ...
    def test_116_string_with_newline(self):
        input = r""" "Newline \n" """
        expect = r"Newline \n,<EOF>"
        self.assertTrue(TestLexer.test(input, expect, 116))
    
    def test_117_string_with_backslash(self):
        input = """ "Backslash \\\\" """
        expect = """Backslash \\\\,<EOF>"""
        self.assertTrue(TestLexer.test(input, expect, 117))
    
    def test_118_string_with_single_quote(self):
    ...
    def test_122_float_literal_2(self):
    ...
    def test_131_multiple_int_literal(self):
    ...
    def test_142_unclosed_string_with_illegal_escape(self):
        input = r""" "ldpv \n nhanvo " """
        expect = "ldpv \\n nhanvo ,<EOF>"
        self.assertTrue(TestLexer.test(input, expect, 142))
        
    def test_143_string_with_legal_escape(self):
        input = """ "ldpv \\n \\t nhanvo" """
        expect = r"ldpv \n \t nhanvo,<EOF>"
        self.assertTrue(TestLexer.test(input, expect, 143))
    
    def test_144_multiple_unclosed_string(self):
    ...
    def test_145_complex_string(self):
    ...
    def test_146_string_in_comment(self):
        input = """
                    Class Program {
    ...
    def test_147_legal_and_illegal_escape(self):
    ...
    def test_152_sample_code_AVL_tree(self):
        input = r"""
                int V = 6;
                int visited = 0;
    ...
    def test_156_all_escape_sequences(self):
        input = r"""
    ...
    def test_157_weird_single_double_quotes(self):
        input = r"""
    ...
    def test_158_code_slinkedlist(self):
        input = r"""
            template<class T>
    ...
    def test_159_sameple_code(self):
        input = r"""
            Class Shape {
    ...
    def test_160_unclosedString_with_escape_seq(self):
        input = r"""
    ...
    def test_163_array_literal(self):
        input = r"""
            Array(1,2,3,4)
    ...
    def test_164_multi_dimensional_array(self):
        input = r"""
            Array (
                Array("Volvo", "22", "18"),
                Array("Saab", "5", "2"),
    ...
    def test_165_sample_code_iterator(self):
        ## has error token
        input = r"""
    ...
    def test_166_sample_code_BKU_tree(self):
        ## has error token
        input = r"""
    ...
    def test_167_combo_int_literals(self):
        input = r"""
    ...
    def test_168_string_operators_2(self):
        input = r"""
    ...
    def test_169_mixed_some_statements(self):
        ## has error token
        input = r"""
    ...
    def test_170_nothing(self):
        input = r"""
            "First string is valid"
            "I don\'t know what tests to write"
            "But this string is not"f
            "I don't know what tests to write"
        """
        # expect = r"""First string is valid,I don\'t know what tests to write,But this string is not,f,Illegal Escape In String: I don't"""
        expect = r"""First string is valid,I don\'t know what tests to write,But this string is not,f,I don't know what tests to write,<EOF>"""
        self.assertTrue(TestLexer.test(input, expect, 170))
        
    def test_171_string_unclosed(self):
        input = r"""
    ...
    def test_172_string_with_tabs(self):
        input = r"""
    ...
    def test_173_sample_code_sorting(self):
        input = r"""
                template <class T>
    ...
    def test_174_error_token_5(self):
        input = r"""
    ...
    def test_175_sample_code_memo(self):
        input = r"""
            Class Program {
    ...
    def test_176_string_with_some_tabs(self):
        input = """
            "abcd\t"
        """
        # expect = """abcd\t,<EOF>"""
    ...
    def test_177_string_with_some_escape(self):
        input = """
            "abc\b\f\t\t\t"
        """
        # expect = """abc\b\f\t\t\t,<EOF>"""
    ...
    def test_178_invalid_escape_quote(self):
    ...
    def test_179_invalid_keywords(self):
    ...
    def test_180_some_invalid_identifiers(self):
        input = r"""
    ...
    def test_181_some_invalid_float(self):
        input = r"""
    ...
    def test_182_some_confused_escape(self):
        input = """
                    "The first string \'"confused\'""
                    "The second string is or not illegal \'n"
                """
        # expect = """The first string '"confused'",Illegal Escape In String: The second string is or not illegal 'n"""
    ...
    def test_183_some_confused_escape_2(self):
        input = r"""
                    "First string \ ' '"
                """
    ...
    def test_184_some_combo_string(self):
        input = r"""
                    ""
    ...
    def test_185_some_sample_code(self):
        input = r"""
    ...
    def test_186_some_illegal(self):
        input = """
                    "abc\\ "    
                """
    ...
    def test_187_some_error_token(self):
        input = """
    ...
    def test_188_some_unclosed_2(self):
        input = """
                    "nhanvo \n "
                """
    ...
    def test_189_some_unclosed_3(self):
        input = """
                    "nhanvo \r "
                """
        expect = "Unclosed String: nhanvo "
    ...
    def test_190_some_unclosed_4(self):
        input = """
                    "nhanvo \f "
                """
        # expect = "nhanvo \f ,<EOF>"
    ...
    def test_191_some_unclosed_5(self):
        input = """
                    "nhanvo \t "
                """
        # expect = "nhanvo \t ,<EOF>"
    ...
    def test_192_some_unclosed_6(self):
        input = """
                    "nhanvo \b "
                """
        # expect = "nhanvo \b ,<EOF>"
    ...
    def test_193_keywords_in_string(self):
        input = """
    ...
    def test_194_invalid_words_in_string(self):
        input = """
                    "Some invalid words: @ ? ` ~ | ^ /"
                """
    ...
    def test_196_unclosed_mixed(self):
        input = """
    ...
    def test_197_code_keywords(self):
        input = r"""
                Class ProgramCode {
                    $numOfShape = 100;
    ...
    def test_198_some_comment(self):
        input = """
                    ##Inside
                    Block
                    Comment ? @@@@@ ^^^^^^ |||||||||||||||
    ...
    def test_199_some_combo_int_literals(self):
        input = r"""
