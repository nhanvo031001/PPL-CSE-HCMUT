...
from main.d96.parser.lexererr import UnterminatedComment
...
class TestUtil:
    @staticmethod
    def makeSource(inputStr,num):       #create testcase file in folder testcases
