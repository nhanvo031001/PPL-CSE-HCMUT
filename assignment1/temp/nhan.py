...
#         input = "abc xyz nhanvo ldpv"
#         expect = "abc,xyz,nhanvo,ldpv,<EOF>"
#         self.assertTrue(TestLexer.test(input,expect,101))
        
#     def test_lower_upper_id(self):
#         input = "aCBbdc nHanVONguyen"
#         expect = "aCBbdc,nHanVONguyen,<EOF>"
...
#         input = "Break Continue If Elseif Else Foreach True False Float Boolean String Int Null Var Val Array Self Return New In Class Constructor Destructor By"
...
#         expect = "1_234.567,4_567_798.1e-10,3_145.5e+10,<EOF>"
...
#                 """
#         expect = "abc ,_____________nhanvo______________,xyz,Error Token \""
